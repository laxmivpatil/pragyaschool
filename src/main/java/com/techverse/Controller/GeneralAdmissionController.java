...
public class GeneralAdmissionController {
	...
	public ResponseEntity<?> createAdmission(@RequestPart(value = "firstName", required = false) String firstName,
		 ...
		 * HttpStatus.OK); } else { String birthC="",lastR="",parentA="",studentA="",
		 * sssmi="", bankD="", castC="",transferC="", profileP=""; //name String
		 * birthCN="",lastRN="",parentAN="",studentAN="", sssmiN="", bankDN="",
		 * castCN="",transferCN="", profilePN=""; //extension String
